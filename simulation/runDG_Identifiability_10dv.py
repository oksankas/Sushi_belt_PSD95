...
modelPrefix = f'{model.modelPrefix}_{valN}'
model.modelPrefix = modelPrefix
runPrefix = 'identifiability_pso10_nm50_ga10'
...
for pni in model.parnames :
    for pvj in rn.parvals :
        rn.cfiCounter = 0
        bestX, bestY = rn.profileChiSq(model, pni, pvj, pso_iter=10, nm_iter=50, ga_cycles=10)
