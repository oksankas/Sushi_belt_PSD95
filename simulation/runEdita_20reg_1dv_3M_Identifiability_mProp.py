...
rn.cfiCounter = 0
log.info(f"pni={pni}, pvj={pvj}, valN={valN}, numPar={numPar}")

#bestX, bestY = rn.profileChiSq(model, pni, pvj, pso_iter=20, nm_iter=50, ga_cycles=250)
bestX, bestY = rn.profileChiSq(model, pni, pvj, pso_iter=2, nm_iter=5, ga_cycles=250)
